...
from ai_agent.src.agents.lab_assistant.prompt import LAB_ASSIST_PROMPT
from ai_agent.src.agents.lab_assistant.solution_code import SOLUTION_CODE_LAB_4
from ai_agent.src.agents.lab_assistant.structures import VibeCodeFunctionOutput, VibeCodeInput
...
class LabAssistantAgent(BaseAgent):
    ...
    async def _lab_code_assist(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        system_template = LAB_ASSIST_PROMPT
